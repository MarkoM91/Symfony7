...
class Subscription
{
    public const ProPlan = 'https://www.sandbox.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=VLRRX7ZGKQ8CS';


    public const EnterprisePlan = 'https://www.sandbox.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=UGB5KZAL3S7V2';
